...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.schedule__info .play', '.overlay').init();
...
function () {
  ...
  _createClass(Difference, [{
    key: "showAndCloseAnimations",
    value: function showAndCloseAnimations(items, counter) {
      var _items$counter$classL;

      var classes = ['animated', 'fadeIn'];

      (_items$counter$classL = items[counter].classList).add.apply(_items$counter$classL, classes);

      setTimeout(function () {
        var _items$counter$classL2;

        (_items$counter$classL2 = items[counter].classList).remove.apply(_items$counter$classL2, classes);
      }, 1000);
    }
  }, {
    key: "bindTriggers",
    value: function bindTriggers(container, items, counter) {
      ...
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== items.length - 2) {
          ...
          _this.showAndCloseAnimations(items, counter);
    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          sibling.classList.toggle('fadeInRight');
